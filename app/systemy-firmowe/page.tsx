    ...
    <div className="text-white">
      ...
      <section className="flex flex-col md:flex-row justify-between pt-16 md:pt-20 px-4 sm:px-8 lg:px-5 pb-10 md:pb-20 gap-10 md:gap-0 max-w-7xl mx-auto w-full">
        <div className="content-center w-full lg:w-1/2">
          ...
          <h2 className="text-lg sm:text-xl md:text-xl text-gray-300 leading-relaxed mb-6">
            Przekształć swoją firmę w dobrze naoliwioną maszynę biznesową. Nasze
            dedykowane systemy firmowe eliminują chaos, automatyzują procesy i
            zwiększają zyski o nawet 300%. Od małych firm po korporacje - każda
            organizacja zasługuje na system, który pracuje dla niej, a nie
            przeciwko niej.
          </h2>
      ...
      <section className="py-20 md:py-28 px-4 sm:px-8 lg:px-30 bg-gradient-to-b from-[#101015] to-[#151515] relative overflow-hidden">
        ...
        <div className="text-center mb-16 relative z-10">
          ...
          <p className="text-gray-400 max-w-3xl mx-auto text-lg leading-relaxed">
            ...
            systemy firmowe, skazują się na powolną śmierć. Nasze rozwiązania to
            nie tylko oprogramowanie - to strategiczna inwestycja w przyszłość
            Twojej organizacji.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
          <div className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-3xl border border-gray-700/50 hover:border-purple-500/50 transition-all duration-500 hover:scale-105 backdrop-blur-sm">
            ...
            <p className="text-gray-400 leading-relaxed mb-4">
              Automatyzacja powtarzalnych zadań pozwala Twoim pracownikom skupić
              się na tym, co naprawdę ważne - kreatywności i rozwoju biznesu.
              Nasze systemy eliminują 80% pracy manualnej, zwiększając
              produktywność o średnio 300%. To jak zatrudnienie dodatkowego
              zespołu bez dodatkowych kosztów.
            </p>
          ...
          <div className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-3xl border border-gray-700/50 hover:border-purple-500/50 transition-all duration-500 hover:scale-105 backdrop-blur-sm">
            ...
            <p className="text-gray-400 leading-relaxed mb-4">
              ...
              kontrolę nad operacjami biznesowymi. Od zarządzania projektami po
              finanse - wszystko w zasięgu jednego kliknięcia. Decyzje
          ...
          <div className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-3xl border border-gray-700/50 hover:border-purple-500/50 transition-all duration-500 hover:scale-105 backdrop-blur-sm">
            ...
            <p className="text-gray-400 leading-relaxed mb-4">
              ...
              analizują wzorce, identyfikują możliwości i przewidują trendy. To
              jak posiadanie zespołu analityków pracującego 24/7, ale bez
      ...
      <section className="py-20 md:py-28 px-4 sm:px-8 lg:px-30 relative overflow-hidden">
        ...
        <div className="text-center mb-16 relative z-10">
          ...
          <p className="text-gray-400 max-w-3xl mx-auto text-lg leading-relaxed">
            Nasz sprawdzony proces gwarantuje szybkie i bezproblemowe wdrożenie.
            Nie ma miejsca na błędy - każdy krok jest precyzyjnie zaplanowany i
            wykonany przez ekspertów z wieloletnim doświadczeniem.
          </p>
        </div>
        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="group bg-gradient-to-br from-blue-900/40 to-purple-900/40 backdrop-blur-sm border border-blue-500/30 rounded-3xl p-8 hover:border-blue-400/50 transition-all duration-500 hover:scale-105">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              ...
              fundament, na którym budujemy system idealnie dopasowany do Twoich
              potrzeb.
            </p>
          </div>
          ...
          <div className="group bg-gradient-to-br from-purple-900/40 to-pink-900/40 backdrop-blur-sm border border-purple-500/30 rounded-3xl p-8 hover:border-purple-400/50 transition-all duration-500 hover:scale-105">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Tworzymy szczegółową architekturę systemu, projektujemy interfejsy
              użytkownika i planujemy integracje. Każdy element jest przemyślany
              pod kątem skalowalności i przyszłego rozwoju.
            </p>
          </div>
          ...
          <div className="group bg-gradient-to-br from-green-900/40 to-blue-900/40 backdrop-blur-sm border border-green-500/30 rounded-3xl p-8 hover:border-green-400/50 transition-all duration-500 hover:scale-105">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Programujemy system w iteracjach, testując każdą funkcjonalność na
              bieżąco. Integrujemy z istniejącymi systemami i bazami danych.
              Jakość kodu to nasz priorytet.
            </p>
          </div>
          ...
          <div className="group bg-gradient-to-br from-cyan-900/40 to-blue-900/40 backdrop-blur-sm border border-cyan-500/30 rounded-3xl p-8 hover:border-cyan-400/50 transition-all duration-500 hover:scale-105">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Wdrażamy system, szkolimy użytkowników i zapewniamy pełne wsparcie
              techniczne. Nie zostawiamy Cię samego - jesteśmy z Tobą na każdym
              etapie.
            </p>
          </div>
        </div>
      ...
      <section className="py-20 md:py-28 px-4 sm:px-8 lg:px-30 bg-gradient-to-r from-blue-900/20 via-purple-900/20 to-pink-900/20 relative overflow-hidden">
        ...
        <div className="text-center max-w-4xl mx-auto relative z-10">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
            ...
            luksus - to konieczność w dzisiejszym świecie biznesowym. Skontaktuj
            się z nami i stwórzmy razem system, który przekształci Twoją firmę w
            dobrze naoliwioną maszynę biznesową.
          </p>
          ...
          <div className="bg-gradient-to-r from-gray-800/50 to-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-3xl p-8 mb-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
              ...
              <div>
                ...
                <div className="text-gray-400 text-sm">Wsparcie techniczne</div>
              </div>
            </div>
          </div>
