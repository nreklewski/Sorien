...
export const metadata: Metadata = {
  title: "Systemy firmowe - dedykowane oprogramowanie | Sorien",
  description:
    "Tworzymy dedykowane systemy firmowe i aplikacje webowe z AI, które automatyzują procesy i zwiększają wydajność. ROI w 4 miesiące. | Sorien",
  openGraph: {
    title: "Systemy firmowe - dedykowane oprogramowanie | Sorien",
    description:
  ...
  return (
    <>
      ...
      <div className="text-white">
          ...
          <section className="flex flex-col md:flex-row justify-between pt-16 md:pt-20 px-4 sm:px-8 lg:px-5 pb-10 md:pb-20 gap-10 md:gap-0 max-w-7xl mx-auto w-full">
            <div className="content-center w-full lg:w-1/2">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[2.7rem] font-bold mb-4 md:mb-6 lg:mb-8 text-white lg:whitespace-nowrap">
                Dedykowane systemy firmowe,
                <br /> które rewolucjonizują zarządzanie
              </h1>
              ...
              <h2 className="text-lg sm:text-xl md:text-xl text-gray-300 leading-relaxed mb-6">
                ...
                korporacje wspieramy nasze systemy{" "}
                <Link
                ...
                , które dodatkowo zwiększają efektywność.
              </h2>
        ...
        {/* Features Section */}
        <Reveal>
          <section className="py-20 md:py-28 px-4 sm:px-8 lg:px-28 bg-gradient-to-b from-[#101015] to-[#151515] relative overflow-hidden">
            ...
            <div className="text-center mb-16 relative z-10">
              ...
              <p className="text-gray-400 max-w-3xl mx-auto text-lg leading-relaxed">
                ...
                systemy firmowe, skazują się na powolną śmierć. Nasze
                rozwiązania to nie tylko oprogramowanie - to strategiczna
              ...
              <RevealGroup intervalMs={120}>
                <div className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-3xl border border-gray-700/50 hover:border-purple-500/50 transition-all duration-500 hover:scale-105 backdrop-blur-sm">
                  ...
                  <p className="text-gray-400 leading-relaxed mb-4">
                    ...
                    skupić się na tym, co naprawdę ważne - kreatywności i
                    rozwoju biznesu. Nasze systemy eliminują 80% powtarzalnej
                    pracy manualnej, znacząco zwiększając produktywność. To jak
                ...
                <div className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-3xl border border-gray-700/50 hover:border-purple-500/50 transition-all duration-500 hover:scale-105 backdrop-blur-sm">
                  ...
                  <p className="text-gray-400 leading-relaxed mb-4">
                    Centralizacja wszystkich procesów w jednym miejscu daje Ci
                    pełną kontrolę nad operacjami biznesowymi. Od zarządzania
                    projektami po finanse - wszystko w zasięgu jednego
                    kliknięcia. Decyzje podejmowane na podstawie danych w czasie
                    rzeczywistym, a nie przeczucia intuicji czy wczorajszej
                    kartki samoprzylepnej.
                  </p>
                  <h4 className="text-lg font-semibold mb-2 text-gray-300">
                    Funkcje kontroli:
                  </h4>
                ...
                <div className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-3xl border border-gray-700/50 hover:border-purple-500/50 transition-all duration-500 hover:scale-105 backdrop-blur-sm">
                  ...
                  <p className="text-gray-400 leading-relaxed mb-4">
                    ...
                    analizują wzorce, identyfikują możliwości i przewidują
                    trendy. To jak posiadanie zespołu analityków pracującego
                    24/7, ale bez kosztów zatrudnienia i błędów ludzkich.
                  </p>
                  <h4 className="text-lg font-semibold mb-2 text-gray-300">
              ...
              <RevealGroup intervalMs={120}>
                ...
                <div className="group bg-gradient-to-br from-purple-900/40 to-pink-900/40 backdrop-blur-sm border border-purple-500/30 rounded-3xl p-8 hover:border-purple-400/50 transition-all duration-500 hover:scale-105">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    ...
                    jest przemyślany pod kątem skalowalności i przyszłego
                    rozwoju.
                  </p>
                </div>
                ...
                <div className="group bg-gradient-to-br from-green-900/40 to-blue-900/40 backdrop-blur-sm border border-green-500/30 rounded-3xl p-8 hover:border-green-400/50 transition-all duration-500 hover:scale-105">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Programujemy system w iteracjach, testując każdą
                    funkcjonalność na bieżąco. Integrujemy z istniejącymi
                    systemami i bazami danych. Jakość usługi to nasz priorytet.
                  </p>
                </div>
                ...
                <div className="group bg-gradient-to-br from-cyan-900/40 to-blue-900/40 backdrop-blur-sm border border-cyan-500/30 rounded-3xl p-8 hover:border-cyan-400/50 transition-all duration-500 hover:scale-105">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    ...
                    wsparcie techniczne. Nie zostawiamy Cię samego - jesteśmy z
                    Tobą na każdym etapie.
                  </p>
                </div>
              </RevealGroup>
            </div>
          ...
          <section className="py-20 md:py-28 px-4 sm:px-8 lg:px-30 bg-gradient-to-b from-[#101011] to-[#0e0d12] relative overflow-hidden">
            ...
            <div className="text-center mb-16 relative z-10">
              ...
              <p className="text-gray-400 max-w-3xl mx-auto text-lg leading-relaxed">
                ...
                rozwiązanie to kompletna platforma biznesowa, która rośnie razem
                z Twoją firmą. Od małej firmy po korporację - wszystko w jednym
                miejscu.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
              <RevealGroup intervalMs={120}>
                ...
                <div className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-3xl border border-gray-700/50 hover:border-purple-500/50 transition-all duration-500 hover:scale-105 backdrop-blur-sm">
                  ...
                  <p className="text-gray-400 leading-relaxed mb-4">
                    Zaawansowany system CRM z automatyzacją procesów
                    sprzedażowych, śledzeniem leadów i zarządzaniem relacjami z
                    klientami. Zwiększa konwersje i lojalność klientów.
                  </p>
                  <ul className="space-y-2 text-sm text-gray-500">
                ...
                <div className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-3xl border border-gray-700/50 hover:border-purple-500/50 transition-all duration-500 hover:scale-105 backdrop-blur-sm">
                  ...
                  <p className="text-gray-400 leading-relaxed mb-4">
                    Zaawansowane dashboardy i raporty w czasie rzeczywistym.
                    Analiza trendów, KPI i metryk biznesowych. Podejmuj decyzje
          ...
          <section className="py-20 md:py-28 px-4 sm:px-8 lg:px-30 bg-gradient-to-r from-blue-900/20 via-purple-900/20 to-pink-900/20 relative overflow-hidden">
            ...
            <div className="text-center max-w-4xl mx-auto relative z-10">
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
                ...
                Skontaktuj się z nami i stwórzmy razem system, który
                przekształci Twoją firmę w dobrze naoliwioną maszynę biznesową.
              </p>
