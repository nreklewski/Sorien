...
export const metadata: Metadata = {
  title: "Rozwiązania AI dla firm | Automatyzacja procesów",
  description:
    "Inteligentne rozwiązania AI dla firm. Automatyzacja procesów, wsparcie decyzji, przewaga konkurencyjna. ROI w 2 miesiące. | Sorien",
  openGraph: {
    title: "Rozwiązania AI dla firm | Automatyzacja procesów",
    description:
          ...
          <section className="flex flex-col md:flex-row justify-between pt-16 md:pt-20 px-4 sm:px-8 lg:px-5 pb-10 md:pb-20 gap-10 md:gap-0 max-w-7xl mx-auto w-full">
            <div className="content-center w-full lg:w-1/2">
              <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-500/20 to-purple-600/20 border border-blue-500/30 rounded-full text-sm font-medium text-blue-300 mb-6">
                ...
                Inteligentne rozwiązania AI dla firm
              </div>
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[2.7rem] font-bold mb-4 md:mb-6 lg:mb-8 text-white lg:whitespace-nowrap">
                Inteligentne rozwiązania AI <br />
                automatyzujące procesy firmowe
              </h1>
              ...
              <h2 className="text-lg sm:text-xl md:text-xl text-gray-300 leading-relaxed mb-6">
                ...
                biznes zasługuje na AI, które pracuje 24/7. Nasze rozwiązania AI
                doskonale współpracują z{" "}
                <Link
              ...
              <RevealGroup intervalMs={120}>
                <div className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-3xl border border-gray-700/50 hover:border-purple-500/50 transition-all duration-500 hover:scale-105 backdrop-blur-sm">
                  ...
                  <p className="text-gray-400 leading-relaxed mb-4">
                    AI automatycznie wykonuje powtarzalne zadania, oszczędzając
                    czas i zasoby. Nasze rozwiązania zwiększają wydajność już w
                    pierwszym tygodniu. To jak zatrudnienie dodatkowego zespołu
                    bez kosztów wynagrodzeń i szkoleń.
                  </p>
                ...
                <div className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-3xl border border-gray-700/50 hover:border-purple-500/50 transition-all duration-500 hover:scale-105 backdrop-blur-sm">
                  ...
                  <p className="text-gray-400 leading-relaxed mb-4">
                    ...
                    podejmowaniu lepszych decyzji biznesowych. Każda
                    rekomendacja jest oparta na danych i trendach rynkowych.
                  </p>
                  <h4 className="text-lg font-semibold mb-2 text-gray-300">
                    Funkcje analityczne:
                  </h4>
        ...
        <Reveal>
          <section className="py-20 md:py-28 px-4 sm:px-8 lg:px-30 relative overflow-hidden">
            ...
            <div className="text-center mb-16 relative z-10">
              ...
              <p className="text-gray-400 max-w-3xl mx-auto text-lg leading-relaxed">
                Nasz sprawdzony proces gwarantuje skuteczne wdrożenie AI w
                Twojej firmie. Każdy krok jest precyzyjnie zaplanowany i
                wykonany przez ekspertów sztucznej inteligencji.
              </p>
            </div>
              ...
              <RevealGroup intervalMs={120}>
                <div className="group bg-gradient-to-br from-blue-900/40 to-purple-900/40 backdrop-blur-sm border border-blue-500/30 rounded-3xl p-8 hover:border-blue-400/50 transition-all duration-500 hover:scale-105">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Analizujemy Twoje procesy biznesowe i identyfikujemy
                    obszary, gdzie AI może przynieść największe korzyści.
                    Tworzymy strategię wdrożenia dopasowaną do Twoich celów.
                  </p>
                </div>
                ...
                <div className="group bg-gradient-to-br from-purple-900/40 to-pink-900/40 backdrop-blur-sm border border-purple-500/30 rounded-3xl p-8 hover:border-purple-400/50 transition-all duration-500 hover:scale-105">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Tworzymy inteligentne modele AI dostosowane do Twoich
                    potrzeb. Każdy model jest zaprojektowany z myślą o
                    maksymalnej efektywności i łatwości użycia.
                  </p>
                </div>
                ...
                <div className="group bg-gradient-to-br from-green-900/40 to-blue-900/40 backdrop-blur-sm border border-green-500/30 rounded-3xl p-8 hover:border-green-400/50 transition-all duration-500 hover:scale-105">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    ...
                    Każda funkcjonalność jest przetestowana i zoptymalizowana
                ...
                <div className="group bg-gradient-to-br from-cyan-900/40 to-blue-900/40 backdrop-blur-sm border border-cyan-500/30 rounded-3xl p-8 hover:border-cyan-400/50 transition-all duration-500 hover:scale-105">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    ...
                    wsparcie techniczne. Jesteśmy z Tobą na każdym etapie
                    rozwoju inteligentnych rozwiązań.
                  </p>
                </div>
              </RevealGroup>
            </div>
          ...
          <section className="py-20 md:py-28 px-4 sm:px-8 lg:px-30 bg-gradient-to-b from-[#101011] to-[#0e0d12] relative overflow-hidden">
            ...
            <div className="text-center mb-16 relative z-10">
              ...
              <p className="text-gray-400 max-w-3xl mx-auto text-lg leading-relaxed">
                ...
                systemy. Nasze rozwiązanie AI to kompletna platforma, która
                rośnie razem z Twoim biznesem.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
              <RevealGroup intervalMs={120}>
                <div className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-3xl border border-gray-700/50 hover:border-purple-500/50 transition-all duration-500 hover:scale-105 backdrop-blur-sm">
                  ...
                  <p className="text-gray-400 leading-relaxed mb-4">
                    AI automatycznie wykonuje powtarzalne zadania, analizuje
                    dane i podejmuje decyzje. Inteligentne systemy pracują 24/7
                    bez przerw.
                  </p>
                  <ul className="space-y-2 text-sm text-gray-500">
                ...
                <div className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-3xl border border-gray-700/50 hover:border-purple-500/50 transition-all duration-500 hover:scale-105 backdrop-blur-sm">
                  ...
                  <p className="text-gray-400 leading-relaxed mb-4">
                    ...
                    analizy trendów, przewidywania zachowań klientów i
                ...
                <div className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-3xl border border-gray-700/50 hover:border-purple-500/50 transition-all duration-500 hover:scale-105 backdrop-blur-sm">
                  ...
                  <p className="text-gray-400 leading-relaxed mb-4">
                    AI dostarcza inteligentne rekomendacje i wspiera
                    podejmowanie decyzji biznesowych. Systemy uczą się z
                    doświadczeń i dostarczają coraz lepsze sugestie.
                  </p>
                  <ul className="space-y-2 text-sm text-gray-500">
          ...
          <section className="py-20 md:py-28 px-4 sm:px-8 lg:px-30 bg-gradient-to-r from-blue-900/20 via-purple-900/20 to-pink-900/20 relative overflow-hidden">
            ...
            <div className="text-center max-w-4xl mx-auto relative z-10">
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
                ...
                Rozwiązania sztucznej inteligencji to nie luksus - to
                konieczność w dzisiejszym świecie biznesowym. Skontaktuj się z
                nami i stwórzmy razem inteligentny system, który przekształci
                Twój biznes.
              </p>
