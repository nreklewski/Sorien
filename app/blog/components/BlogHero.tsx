...
export default function BlogHero({ imageSrc, imageAlt }: BlogHeroProps) {
  return (
    <section className="relative w-full pb-8 md:pt-12 md:pb-12">
      {/* Decorative Background Block */}
      <div className="hidden md:block absolute top-15 left-1/2 -translate-x-1/2 w-[1500px] h-[350px] md:h-[450px] bg-gradient-to-br from-[#101015] via-[#151515] to-[#101015]"></div>
