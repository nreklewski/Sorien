...
export const metadata: Metadata = {
  title: "Strony internetowe z SEO | Profesjonalne projekty",
  description:
    "Profesjonalne strony internetowe z optymalnym SEO. Nowoczesne projekty, szybkie wdrożenie, pełne wsparcie. ROI w 3 miesiące. | Sorien",
  openGraph: {
    title: "Strony internetowe z SEO | Profesjonalne projekty",
    description:
        ...
        <Reveal>
          <section className="flex flex-col md:flex-row justify-between pt-16 md:pt-20 px-4 sm:px-8 lg:px-5 pb-10 md:pb-20 gap-10 md:gap-0 max-w-7xl mx-auto w-full">
            ...
            <div className="relative w-full hidden lg:w-auto lg:flex items-center justify-center">
              ...
              >
                <title id="svgTitle">
                  Profesjonalna strona www – tworzenie stron internetowych
                </title>
                <desc id="svgDesc">
                  Nowoczesna, kolorowa grafika strony internetowej symbolizująca
                  ofertę projektowania i tworzenia responsywnych stron
                  internetowych dla firm i freelancerów.
                </desc>
                <defs>
                  <linearGradient
                    id="cardGradient"
          ...
          <section className="py-20 md:py-28 px-4 sm:px-8 lg:px-30 bg-gradient-to-b from-[#101015] to-[#151515] relative overflow-hidden">
            ...
            <div className="text-center mb-16 relative z-10">
              ...
              <p className="text-gray-400 max-w-3xl mx-auto text-lg leading-relaxed">
                W dzisiejszym świecie, firmy które nie mają profesjonalnej
                strony internetowe, tracą ogromne możliwości biznesowe. Nasze
                rozwiązania to nie tylko strony - to strategiczna inwestycja w
                wizerunek i zaufanie klientów.
              </p>
            </div>
              ...
              <RevealGroup intervalMs={120}>
                <div className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-3xl border border-gray-700/50 hover:border-purple-500/50 transition-all duration-500 hover:scale-105 backdrop-blur-sm">
                  ...
                  <p className="text-gray-400 leading-relaxed mb-4">
                    Profesjonalna strona internetowa buduje zaufanie i
                    wiarygodność w oczach klientów. Nasze strony znacznie
                    zwiększają zaufanie wszystkich i poprawiają pierwsze
                    wrażenie. To jak zatrudnienie najlepszego PR-owca, ale w
                    formie cyfrowej.
                  </p>
                ...
                <div className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-3xl border border-gray-700/50 hover:border-purple-500/50 transition-all duration-500 hover:scale-105 backdrop-blur-sm">
                  ...
                  <p className="text-gray-400 leading-relaxed mb-4">
                    Wykorzystujemy najnowsze technologie Next.js, które
                    zapewniają doskonałe SEO. Server-side rendering,
                    automatyczna optymalizacja obrazów i błyskawiczne ładowanie
                ...
                <div className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-3xl border border-gray-700/50 hover:border-purple-500/50 transition-all duration-500 hover:scale-105 backdrop-blur-sm">
                  ...
                  <p className="text-gray-400 leading-relaxed mb-4">
                    Zaawansowane formularze kontaktowe, integracja z social
                    media i automatyczne powiadomienia sprawiają, że każdy
                    klient może łatwo nawiązać kontakt. Wykorzystujemy najnowsze
                    technologie komunikacji, aby maksymalizować szanse na
                    nawiązanie współpracy i zwiększyć konwersję.
                  </p>
                  <h4 className="text-lg font-semibold mb-2 text-gray-300">
                    Funkcje komunikacji:
                  </h4>
              ...
              <RevealGroup intervalMs={120}>
                <div className="group bg-gradient-to-br from-blue-900/40 to-purple-900/40 backdrop-blur-sm border border-blue-500/30 rounded-3xl p-8 hover:border-blue-400/50 transition-all duration-500 hover:scale-105">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Poznajemy Twoje potrzeby, oczekiwania i grupę docelową.
                    Tworzymy strategię wizerunkową dopasowaną do Twojej branży.
                  </p>
                </div>
                ...
                <div className="group bg-gradient-to-br from-green-900/40 to-blue-900/40 backdrop-blur-sm border border-green-500/30 rounded-3xl p-8 hover:border-green-400/50 transition-all duration-500 hover:scale-105">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Programujemy stronę, dbając o wydajność, SEO i
                    bezpieczeństwo. Optymalizujemy pod kątem wyszukiwarek.
                  </p>
                </div>
        ...
        <Reveal>
          <section className="py-20 md:py-28 px-4 sm:px-8 lg:px-30 bg-gradient-to-b from-[#101011] to-[#0e0d12] relative overflow-hidden">
            ...
            <div className="text-center mb-16 relative z-10">
              ...
              <p className="text-gray-400 max-w-3xl mx-auto text-lg leading-relaxed">
                Nie musisz martwić się o dodatkowe narzędzia. Nasze rozwiązanie
                to kompletna platforma wizerunkowa, która rośnie razem z Twoim
                biznesem.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
              <RevealGroup intervalMs={120}>
                <div className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-3xl border border-gray-700/50 hover:border-purple-500/50 transition-all duration-500 hover:scale-105 backdrop-blur-sm">
                  ...
                  <p className="text-gray-400 leading-relaxed mb-4">
                    Profesjonalna strona buduje zaufanie i ułatwia zdobywanie
                    nowych klientów. To pierwszy krok do budowania silnej marki.
                  </p>
                  <ul className="space-y-2 text-sm text-gray-500">
                ...
                <div className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-3xl border border-gray-700/50 hover:border-purple-500/50 transition-all duration-500 hover:scale-105 backdrop-blur-sm">
                  ...
                  <p className="text-gray-400 leading-relaxed mb-4">
                    ...
                    znajdowana przez potencjalnych klientów. Zwiększ swoją
                    obecność online.
                  </p>
                  <ul className="space-y-2 text-sm text-gray-500">
