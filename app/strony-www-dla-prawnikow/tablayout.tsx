  ...
  const tabs: TabData[] = [
    {
      ...
      description:
        "Profesjonalna strona internetowa przyciąga nowych klientów i buduje zaufanie. Dzięki optymalizacji SEO i lokalnemu pozycjonowaniu, Twoja kancelaria będzie łatwo znajdowana przez klientów potrzebujących pomocy prawnej.",
    },
    {
      ...
      description:
        "Nowoczesny design i wysokiej jakości treści budują profesjonalny wizerunek Twojej kancelarii. Klienci z większym zaufaniem wybierają prawników z elegancką i wiarygodną stroną internetową.",
    },
    {
      id: "latwy-kontakt",
      title: "Łatwy kontakt i konsultacje",
      icon: (
        <svg
          className="w-6 h-6 text-white"
          fill="none"
      ...
      description:
        "Intuicyjny system umawiania konsultacji online i łatwy kontakt z kancelarią zwiększają wygodę klientów. Możliwość umówienia spotkania 24/7 i automatyczne przypomnienia o terminach.",
    },
    {
    ...
    <section className="py-14 md:py-20 px-4 sm:px-8 lg:px-30">
      <div className="text-center mb-10 md:mb-16">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-2 md:mb-4 text-white">
          Jak nasze strony www wspierają Twoją kancelarię
        </h2>
        <p className="text-gray-300 max-w-3xl mx-auto text-sm md:text-base">
          Dzięki profesjonalnej witrynie internetowej Twoja kancelaria może
