...
const VerticalTabLayout: React.FC = () => {
  ...
  const tabs: TabData[] = [
    ...
    },
    {
      ...
      description:
        "Tworzymy spójną tożsamość wizualną i komunikację marki, która wyróżnia Twój salon na tle konkurencji. Profesjonalny wizerunek online buduje zaufanie i lojalność klientów.",
    },
    {
      id: "latwy-kontakt",
      ...
      description:
        "Implementujemy zaawansowane systemy obsługi klienta, które umożliwiają rezerwację online, automatyczne powiadomienia i personalizację usług. To znacznie poprawia doświadczenie klientów i zwiększa ich satysfakcję.",
    },
    {
    ...
    <section className="py-14 md:py-20 px-4 sm:px-8 lg:px-30">
      <div className="text-center mb-10 md:mb-16">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-2 md:mb-4 text-white">
          Dlaczego wybrać nasze rozwiązania dla salonów beauty?
        </h2>
        <p className="text-gray-300 max-w-3xl mx-auto text-sm md:text-base">
          ...
          specjalnie dla branży beauty, aby maksymalizować potencjał biznesowy
          i zapewniać doskonałe doświadczenie zarówno dla salonu, jak i klientów.
        </p>
      </div>
