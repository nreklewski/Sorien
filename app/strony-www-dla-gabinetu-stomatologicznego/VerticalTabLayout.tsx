...
const VerticalTabLayout: React.FC = () => {
  const [activeTab, setActiveTab] = useState("wiecej-pacjentow");
  ...
  const tabs: TabData[] = [
    {
      ...
      description:
        "Profesjonalna strona internetowa przyciąga nowych klientów i buduje zaufanie. Dzięki optymalizacji SEO i lokalnemu pozycjonowaniu, Twój gabinet będzie łatwo znajdowany przez pacjentów w Twojej okolicy.",
    },
    {
      ...
      description:
        "Nowoczesny design i wysokiej jakości treści budują profesjonalny wizerunek Twojego gabinetu. Pacjenci z większym zaufaniem wybierają kliniki z elegancką stroną internetową.",
    },
    {
      id: "latwy-kontakt",
      ...
      description:
        "Intuicyjny system rejestracji online i łatwy kontakt z gabinetem zwiększają wygodę pacjentów. Możliwość umówienia wizyty 24/7 i automatyczne przypomnienia SMS.",
    },
    {
    ...
    <section className="py-14 md:py-20 px-4 sm:px-8 lg:px-30">
      <div className="text-center mb-10 md:mb-16">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-2 md:mb-4 text-white">
          Jak nasze strony www wspierają Twój gabinet
        </h2>
        <p className="text-gray-300 max-w-3xl mx-auto text-sm md:text-base">
          Dzięki profesjonalnej witrynie internetowej Twój gabinet może
