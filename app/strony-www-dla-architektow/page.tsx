...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.sorien.pl/strony-www-dla-architektow",
  },
};
  ...
  const schemaData = [
    {
      ...
      "@type": "WebSite",
      name: "Sorien – Strony www dla architektów",
      url: "https://www.sorien.pl/strony-www-dla-architektow",
    },
    {
      "@context": "https://schema.org",
      ...
      description:
        "Tworzymy nowoczesne strony internetowe dla architektów i pracowni – z rozbudowanym portfolio, zapytaniami ofertowymi i SEO lokalnym.",
    },
  ];
  return (
    <>
      <Script
        id="schema-architects"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-center sm:text-left mt-6 text-base sm:text-lg text-white/80 max-w-prose">
                  ...
                  eksponują charakter architekta i skutecznie zamieniają
                  odwiedzających w zainteresowanych – od domów jednorodzinnych
                  po projekty komercyjne.
                </p>
            ...
            <div className="max-w-7xl mx-auto text-white/90">
              <article className="space-y-10 leading-relaxed">
                <h2 className="text-center text-2xl sm:text-4xl xl:text-5xl font-bold text-white">
                  Pytania o strony www dla architektów
                </h2>
                ...
                <div className="md:flex md:justify-start">
                  <div className="md:w-[92%] bg-white/5 border border-gray-700/50 rounded-xl p-6 hover:bg-white/10 hover:border-blue-400/50 hover:scale-[1.02] hover:shadow-lg hover:shadow-blue-500/20 transition-all duration-300 ease-out cursor-pointer">
                    ...
                    <p className="mt-3 text-gray-300 text-sm">
                      Koszt zależy od zakresu funkcji: od eleganckiej wizytówki
                      z portfolio po zaawansowaną prezentację realizacji z
                      filtrami, studiami przypadków i blogiem. Przygotujemy
                      wariant dopasowany do etapu rozwoju Twojej pracowni.
                    </p>
                  </div>
                </div>
                ...
                <div className="md:flex md:justify-end">
                  <div className="md:w-[92%] bg-white/5 border border-gray-700/50 rounded-xl p-6 hover:bg-white/10 hover:border-purple-400/50 hover:scale-[1.02] hover:shadow-lg hover:shadow-purple-500/20 transition-all duration-300 ease-out cursor-pointer">
                    <h3 className="font-semibold text-white text-base">
                      Jak powinna wyglądać skuteczna strona dla architekta?
                    </h3>
                    <p className="mt-3 text-gray-300 text-sm">
                      Kluczowe są: wyraźne portfolio, opis procesu projektowego,
                      referencje inwestorów oraz szybki kontakt. Dbamy o SEO na
                      frazy typu „architekt [miasto]” i „pracownia
                      architektoniczna [miasto]”.
                    </p>
                  </div>
                </div>
                ...
                <div className="md:flex md:justify-start">
                  <div className="md:w-[92%] bg-white/5 border border-gray-700/50 rounded-xl p-6 hover:bg-white/10 hover:border-green-400/50 hover:scale-[1.02] hover:shadow-lg hover:shadow-green-500/20 transition-all duration-300 ease-out cursor-pointer">
                    <h3 className="font-semibold text-white text-base">
                      Po co architektowi strona internetowa?
                    </h3>
                    <p className="mt-3 text-gray-300 text-sm">
                      Inwestorzy rozpoczynają poszukiwania w Google i social
                      media. Profesjonalna strona to centrum Twojej marki:
                      prezentuje styl, doświadczenie i usprawnia kontakt w
                      sprawie wycen.
                    </p>
                  </div>
                </div>
                ...
                <div className="md:flex md:justify-end">
                  <div className="md:w-[92%] bg-white/5 border border-gray-700/50 rounded-xl p-6 hover:bg-white/10 hover:border-orange-400/50 hover:scale-[1.02] hover:shadow-lg hover:shadow-orange-500/20 transition-all duration-300 ease-out cursor-pointer">
                    <h3 className="font-semibold text-white text-base">
                      Jakie elementy na stronie architekta działają najlepiej?
                    </h3>
                    <p className="mt-3 text-gray-300 text-sm">
                      Sprawdza się: galeria realizacji z krótkimi opisami, case
                      studies pokazujące wyzwania i efekty, sekcja „jak
                      pracujemy”, oraz formularz zapytania z możliwością
                      załączenia plików.
                    </p>
                  </div>
                </div>
                ...
                <div className="md:flex md:justify-start">
                  <div className="md:w-[92%] bg-white/5 border border-gray-700/50 rounded-xl p-6 hover:bg-white/10 hover:border-pink-400/50 hover:scale-[1.02] hover:shadow-lg hover:shadow-pink-500/20 transition-all duration-300 ease-out cursor-pointer">
                    <h3 className="font-semibold text-white text-base">
                      Czy strona www realnie zwiększa liczbę zapytań od
                      inwestorów?
                    </h3>
                    <p className="mt-3 text-gray-300 text-sm">
                      Tak – dzięki SEO lokalnemu, jasnym CTA i dobrze
                      zaprezentowanym realizacjom zwiększamy liczbę
                      wartościowych zapytań o współpracę.
                    </p>
                  </div>
                </div>
              </article>
          ...
          <section className="pt-12 md:pt-20 px-4 sm:px-8 lg:px-30">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-2 md:mb-4 text-white">
                Rozwiązania IT dla pracowni architektonicznych
              </h2>
              <p className="text-gray-400 max-w-3xl mx-auto text-base md:text-lg">
                Szukasz sposobów, by przyspieszyć pozyskiwanie inwestorów i
                lepiej prezentować realizacje? Oto narzędzia, które wdrażamy w
                stronach dla architektów.
              </p>
            </div>
          </section>
        </Reveal>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-gradient-to-br from-purple-900/20 to-pink-900/20 backdrop-blur-sm border border-purple-500/20 rounded-3xl p-8 hover:border-purple-400/40 transition-all duration-500 hover:scale-105">
                  <div className="text-center mb-8">
                    ...
                    <p className="text-gray-300 text-lg">
                      Dedykowane aplikacje, które porządkują ofertę, usprawniają
                      komunikację i wspierają obsługę klientów.
                    </p>
                  </div>
                  <ul className="space-y-4">
                    <li className="flex items-start space-x-3">
                      ...
                      <span className="text-gray-300">
                        Portfolio z filtrami kategorii
                      </span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <span className="w-2 h-2 bg-purple-400 rounded-full mt-2 flex-shrink-0"></span>
                      <span className="text-gray-300">
                        CRM zapytań i statusów projektów
                      </span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <span className="w-2 h-2 bg-purple-400 rounded-full mt-2 flex-shrink-0"></span>
                      <span className="text-gray-300">
                        Formularz zapytań z załącznikami
                      </span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <span className="w-2 h-2 bg-purple-400 rounded-full mt-2 flex-shrink-0"></span>
                      <span className="text-gray-300">
                        Integracje z mapami i social media
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-gradient-to-br from-green-900/20 to-blue-900/20 backdrop-blur-sm border border-green-500/20 rounded-3xl p-8 hover:border-green-400/40 transition-all duration-500 hover:scale-105">
                  <div className="text-center mb-8">
                    ...
                    <p className="text-gray-300 text-lg">
                      Zwiększ widoczność pracowni na frazy lokalne i branżowe,
                      docierając do inwestorów z Twojego regionu.
                    </p>
                  </div>
                  <ul className="space-y-4">
                    <li className="flex items-start space-x-3">
                    ...
                    <li className="flex items-start space-x-3">
                      <span className="w-2 h-2 bg-green-400 rounded-full mt-2 flex-shrink-0"></span>
                      <span className="text-gray-300">
                        Blog z poradami dla inwestorów
                      </span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <span className="w-2 h-2 bg-green-400 rounded-full mt-2 flex-shrink-0"></span>
                ...
                <div className="bg-gradient-to-br from-blue-900/20 to-purple-900/20 backdrop-blur-sm border border-blue-500/20 rounded-3xl p-8 hover:border-blue-400/40 transition-all duration-500 hover:scale-105">
                  <div className="text-center mb-8">
                    ...
                    <p className="text-gray-300 text-lg">
                      Zautomatyzuj obsługę zapytań i komunikację z klientami,
                      aby skupić się na projektowaniu.
                    </p>
                  </div>
                  <ul className="space-y-4">
                    <li className="flex items-start space-x-3">
                      ...
                      <span className="text-gray-300">
                        Autoresponder do zapytań
                      </span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <span className="w-2 h-2 bg-blue-400 rounded-full mt-2 flex-shrink-0"></span>
                      <span className="text-gray-300">
                        Kalendarz spotkań online
                      </span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <span className="w-2 h-2 bg-blue-400 rounded-full mt-2 flex-shrink-0"></span>
                      <span className="text-gray-300">
                        Sekwencje mailowe z materiałami PDF
                      </span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <span className="w-2 h-2 bg-blue-400 rounded-full mt-2 flex-shrink-0"></span>
                      <span className="text-gray-300">
                        Analityka konwersji i źródeł ruchu
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="flex flex-col lg:flex-row items-center gap-12">
                ...
                <div className="flex-1 max-w-2xl">
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-white">
                    Rozwijaj swoją pracownię z naszą pomocą
                  </h2>
                  <p className="text-lg md:text-xl text-gray-300 mb-8 leading-relaxed">
                    Dołącz do pracowni, które dzięki nowej stronie częściej
                    docierają do idealnych inwestorów i wygrywają więcej
                    projektów.
                  </p>
                  ...
                  <div className="space-y-4 mb-8">
                    ...
                    <div className="flex items-center text-gray-300">
                      ...
                      <span className="text-base md:text-lg">
                        Indywidualne podejście do każdej pracowni
                      </span>
                    </div>
                    <div className="flex items-center text-gray-300">
                      <svg
