          ...
          <div className="lg:col-span-2">
            <div className="mb-6">
              ...
              <p className="text-gray-400 max-w-md leading-relaxed">
                We specialize in creating bespoke software solutions that drive
                business growth and enhance operational efficiency. From
                business card websites to complex internal systems.
              </p>
            </div>
            ...
            <div className="space-y-2 text-gray-400">
              <p className="flex items-center gap-2">
                ...
                <a href="mailto:hello@sorien.com" className="hover:underline">
                  hello@sorien.com
                </a>
              </p>
              <p className="flex items-center gap-2">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              © 2024 Sorien. All rights reserved.
            </p>
